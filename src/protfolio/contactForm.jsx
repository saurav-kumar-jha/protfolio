            ...
            <section className="h-[100%] w-fit border border-transparent ">
                <div className="h-[80%] w-[100%] mx-auto px-3 py-2 border border-transparent ">
                    ...
                    <form onSubmit={handleFormsubmit}>
                        <div className="border rounded p-2 gap-2 my-2 flex flex-col  border-transparent">
                            <label htmlFor="name">Name:</label>
                            <input className={`h-auto text-[{Contextvalue==black?white:black}] overflow-y-scroll overflow-x-hidden border-transparent rounded px-[12px] hover:border-[${color}] border outline-none bg-[#ffffff1c]  py-[5px] `} type="text" id="name" name="name" value={formInput.name} onChange={handleFormInput}  required/>
                        </div>
                        <div className="border rounded p-2 gap-2 my-2 flex flex-col  border-transparent">
