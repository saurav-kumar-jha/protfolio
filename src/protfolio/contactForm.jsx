...
export const ContactForm = () => {
    ...
    const handleFormsubmit = async (event) => {
        ...
        setformInput({ name: "", email: "", message: "", mob:"" })
    }
                ...
                <div className="h-[80%] w-[100%] mx-auto px-3 py-2 border border-transparent ">
                    ...
                    <form onSubmit={handleFormsubmit}>
                        ...
                        <div className={Css} >
                            ...
                            <div className="flex h-auto text-[{Contextvalue==black?white:black}] overflow-y-scroll overflow-x-hidden border-transparent rounded pl-[12px] hover:border-black border outline-none bg-[#ffffff1c]  ">
                                <p className="py-[5px] " >+91</p>
                                <input className={`h-auto overflow-y-scroll overflow-x-hidden border-transparent  num px-[12px] border outline-none bg-transparent mr-[-2px] py-[5px] w-full `} type="mob" id="mob" name="mob" value={formInput.mob} onChange={handleFormInput} required />
                            </div>
                        </div>
                        <div className={Css}>
